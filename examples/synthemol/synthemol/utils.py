...
def random_choice(rng: np.random.Generator, array: list[Any], size:(int)=None, replace: bool=True) ->Any:
    ...
    return [array[i] for i in rng.choice(len(array), size=size, replace=
        replace)]
