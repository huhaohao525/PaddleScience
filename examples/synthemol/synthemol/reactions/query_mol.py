...
class QueryMol:
    ...
    def __init__(self, smarts: str) ->None:
        ...
        (self._allowed_building_block_set) = (self._allowed_building_block_list
            ) = None
    ...
    def allowed_building_blocks(self, allowed_building_blocks: Iterable[str]
        ) ->None:
        ...
        if self._allowed_building_block_set is not None:
            raise ValueError(
                'Allowed building block SMILES has already been set.')
        self._allowed_building_block_set = set(allowed_building_blocks)
        self._allowed_building_block_list = sorted(self.
            _allowed_building_block_set)
    ...
    def has_match(self, smiles: str) ->bool:
        ...
        """
        if (self._allowed_building_block_set is not None and smiles not in
            self._allowed_building_block_set):
            if (self._all_building_block_set is not None and smiles not in
                self._all_building_block_set):
                pass
            else:
                return False
